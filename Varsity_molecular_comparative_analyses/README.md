...
- `trajectory_DE.R`: Loads counts/FPKM/metadata from `files/`, runs PCA, DESeq2 contrasts, DEG summaries, and figure exports under `Figs/Manuscript_EPS/Fig2_new`.
...
- Varsity expression/metadata: `files/sample_metadata_filtered.txt`, plus `files/hallmark_pathways_genes_all.csv`.
